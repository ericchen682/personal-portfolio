  ...
  return (
    <section id="honors" className="py-12 sm:py-16">
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-6">honors & awards</h2>
          ...
          {items.map((item, i) => (
            <li key={i} className="p-4 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
              <div className="flex flex-wrap items-baseline gap-2">
                ...
                <span className="text-slate-600 dark:text-slate-300">{item.issuer}</span>
              </div>
